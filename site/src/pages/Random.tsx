  ...
  return (
    <>
      <SEOHead
        ...
        description="Watch a random movie trailer from The Trailer Database. Discover new movies from a collection of 100,000+ films."
      />
      ...
      <div className="min-h-[80vh] flex flex-col items-center justify-center px-4 pt-24 pb-16">
        <header className="text-center mb-10">
          ...
          <p className="text-text-muted font-body text-base mt-2 max-w-md mx-auto">
            Discover something new. A random trailer from over 100,000 movies.
          </p>
        </header>
